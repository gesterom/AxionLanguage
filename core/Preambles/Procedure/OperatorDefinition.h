...
extern std::vector<std::pair<std::string, ProcedureTokenType>> lexerOperators;
/*
std::vector<OperatorDefinition> operators = {
	...
	OperatorDefinition{ {"?"}, 1, true, OperatorDefinition::infix,OperandType::Operand_atom,OperandType::Operand_atom,OperandType::Operand_atom}, // Scope resolution and member access
	OperatorDefinition{ {"?"}, 1, true, OperatorDefinition::postfix,OperandType::Operand_atom,OperandType::Operand_null,OperandType::Operand_atom}, // Scope resolution and member access
	OperatorDefinition{ {"."}, 1, true, OperatorDefinition::infix,OperandType::Operand_atom,OperandType::Operand_atom,OperandType::Operand_atom}, // Scope resolution and member access
	// copy person.name ++
